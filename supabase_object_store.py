...
SUPABASE_URL = "https://hofhgmuuwvkacoricjic.supabase.co/" # Replace with your Supabase URL
SUPABASE_KEY = "sb_secret_3pIkt1GfnLIggz3AgrdX8g_atJDMTE1" # Replace with your Supabase API key

supabase: Client = create_client(SUPABASE_URL, SUPABASE_KEY)

bucket_name = "image1" # Name of the bucket to be created
image_path = "PES1UG23CS640.jpg"  # Replace with the local image path
image_name = "PES1UG23CS640"  # Desired name for the uploaded file
